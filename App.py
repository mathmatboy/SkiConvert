...
"""Fonction pour enregistrer nos fichier en CSV """
...
window = Tk()
window.iconbitmap('C:\\Users\\mathieu\\Documents\\project\\NAME\\SkiConverter\\logo.ico')
window.title("SkiConverter - ****** tunnel")
...
img_bp_config = PhotoImage(file="C:\\Users\\mathieu\\Documents\\project\\NAME\\SkiConverter\\bp_config.png")
...
img_bp_upload = PhotoImage(file="C:\\Users\\mathieu\\Documents\\project\\NAME\\SkiConverter\\bp_upload.png")
...
img_bp_quit = PhotoImage(file="C:\\Users\\mathieu\\Documents\\project\\NAME\\SkiConverter\\bp_quit.png")
...
img_bp_CSV = PhotoImage(file="C:\\Users\\mathieu\\Documents\\project\\NAME\\SkiConverter\\bp_CSV.png")
...
img_bp_view = PhotoImage(file="C:\\Users\\mathieu\\Documents\\project\\NAME\\SkiConverter\\bp_view.png")
